...
st.subheader("اختر الباقة المناسبة لك و احصل على تحليلك الفلكي , يمكن الحصول على هدية بأحد المؤلفات الخاصة بي في حال اخترت متجر أمازون للدفع")
st.markdown("---")
...
# روابط الدفع لمتجر أمازون (بالدولار الأمريكي) و روابط بايبال (بالدولار الأمريكي) مرتبطة بمفاتيح دقيقة
store_links = {
...
paypal_links = {
    ...
    "باقة الاستشارة الصوتية": "https://paypal.me/MulhamHalabieh/99",
    "الباقة الشاملة الكبرى (تقرير + استشارة)": "https://paypal.me/MulhamHalabieh/119"
}
...
if service_choice == "باقة تقرير PDF":
    ...
    * **💰 السعر:** 25 دولار (عبر متجر أمازون) أو $25 (عبر بايبال).
    * **🎁 هدية إضافية في حال الدفع من خلال متجر أمازون:** كتاب الكتروني باللغة الانجليزية **"نظرية مصفوفة زحل"**.
    """)
    ...
    * **💰 السعر:** 99 دولار (عبر متجر أمازون) أو $99 (عبر بايبال).
    * **🎁 هدية إضافية في حال الدفع من خلال متجر أمازون:** كتاب الكتروني باللغة الانجليزية **"نظرية رادار نبتون هوميا ايريس"**.
    """)
    ...
    * **💰 السعر:** 119 دولار (عبر متجر أمازون) أو $119 (عبر بايبال).
    * **🎁 هدية إضافية في حال الدفع من خلال متجر أمازون:** كتاب الكتروني باللغة الانجليزية **"نظرية مصفوفة هوميا إيريس المؤسسية"**.
    """)
    show_local_html_sample("PDF_Example.html")
...
if service_choice != "اختر الباقة...":
    ...
    st.markdown("""
    1. **أتمم عملية الدفع** بالطريقة التي تفضلها (عبر متجر أمازون بالبطاقة أو عبر بايبال).
